...
public class ComputerGame implements Game {
    ...
    public ComputerGame(boolean singlePlayer) {
    ...
    private void startGame() {
        Player computerOne = new ComputerPlayer(PlayerColor.WHITE, "Computer One");
        computerOne.setReady(true);
        players.put(computerOne.getColor(), computerOne);
        Player computerTwo = new ComputerPlayer(PlayerColor.BLACK, "Computer Two");
        computerTwo.setReady(true);
        players.put(computerTwo.getColor(), computerTwo);
        hasStarted = true;
        while (hasStarted){
            Move computerMove = ComputerMoveStrategy.makeComputerMove(board, playerWhoHasTurn);
            doneMoves.add(computerMove);
